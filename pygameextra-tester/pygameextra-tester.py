...
s1 = pe.Sprite(pe.Sheet(sp+"rows.png", pe.SHEET_VERTICAL(16, 16)), (250, 250), (0, 0), pivot="topleft")  # Rows sprite
s2 = pe.Sprite(pe.Sheet(sp+"columns.png", pe.SHEET_HORIZONTAL(32, 32)), (250, 250), (250, 0), pivot="topleft")  # Columns sprite
...
while True:
    ...
    if test == "":
        ...
        pe.button.rect((100, 200, 100, 50), pe.colors.white, pe.colors.lightgray, bt[1], action=set_test, data="slider")
        pe.button.rect((200, 200, 100, 50), pe.colors.white, pe.colors.lightgray, bt[3], action=set_test, data="sprite")
